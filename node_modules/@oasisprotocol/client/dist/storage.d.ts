 ...
 */
export declare const ERR_LIMIT_REACHED_CODE = 5;
export declare const MKVS_CHECKPOINT_MODULE_NAME = "storage/mkvs/checkpoint";
/**
 * ErrCheckpointNotFound is the error when a checkpoint is not found.
 */
export declare const ERR_CHECKPOINT_NOT_FOUND_CODE = 1;
/**
 * ErrChunkNotFound is the error when a chunk is not found.
 */
export declare const ERR_CHUNK_NOT_FOUND_CODE = 2;
/**
 ...
 */
export declare const MKVS_DB_ERR_INVALID_MULTIPART_VERSION_CODE = 14;
/**
 ...
 */
export declare const MKVS_DB_ERR_UPGRADE_IN_PROGRESS_CODE = 15;
export declare function openReceipt(chainContext: string, receipt: types.SignatureSigned): Promise<types.StorageReceiptBody>;
export declare function signReceipt(signer: signature.ContextSigner, chainContext: string, receiptBody: types.StorageReceiptBody): Promise<types.SignatureSigned>;
