 ...
 * registration.
 */
export declare const REGISTER_ENTITY_SIGNATURE_CONTEXT = "oasis-core/registry: register entity";
/**
 ...
 */
export declare const REGISTER_GENESIS_ENTITY_SIGNATURE_CONTEXT = "oasis-core/registry: register entity";
/**
 * RegisterNodeSignatureContext is the context used for node
 * registration.
 */
export declare const REGISTER_NODE_SIGNATURE_CONTEXT = "oasis-core/registry: register node";
/**
 ...
 * migrating existing registrations into a new genesis document.
 */
export declare const REGISTER_GENESIS_NODE_SIGNATURE_CONTEXT = "oasis-core/registry: register node";
/**
 * MethodRegisterEntity is the method name for entity registrations.
 */
export declare const METHOD_REGISTER_ENTITY = "registry.RegisterEntity";
/**
 * MethodDeregisterEntity is the method name for entity deregistrations.
 */
export declare const METHOD_DEREGISTER_ENTITY = "registry.DeregisterEntity";
/**
 * MethodRegisterNode is the method name for node registrations.
 */
export declare const METHOD_REGISTER_NODE = "registry.RegisterNode";
/**
 * MethodUnfreezeNode is the method name for unfreezing nodes.
 */
export declare const METHOD_UNFREEZE_NODE = "registry.UnfreezeNode";
/**
 * MethodRegisterRuntime is the method name for registering runtimes.
 */
export declare const METHOD_REGISTER_RUNTIME = "registry.RegisterRuntime";
/**
 * GasOpRegisterEntity is the gas operation identifier for entity registration.
 */
export declare const GAS_OP_REGISTER_ENTITY = "register_entity";
/**
 * GasOpDeregisterEntity is the gas operation identifier for entity deregistration.
 */
export declare const GAS_OP_DEREGISTER_ENTITY = "deregister_entity";
/**
 * GasOpRegisterNode is the gas operation identifier for entity registration.
 */
export declare const GAS_OP_REGISTER_NODE = "register_node";
/**
 * GasOpUnfreezeNode is the gas operation identifier for unfreezing nodes.
 */
export declare const GAS_OP_UNFREEZE_NODE = "unfreeze_node";
/**
 * GasOpRegisterRuntime is the gas operation identifier for runtime registration.
 */
export declare const GAS_OP_REGISTER_RUNTIME = "register_runtime";
/**
 * GasOpRuntimeEpochMaintenance is the gas operation identifier for per-epoch
 * runtime maintenance costs.
 */
export declare const GAS_OP_RUNTIME_EPOCH_MAINTENANCE = "runtime_epoch_maintenance";
/**
 * GasOpUpdateKeyManager is the gas operation identifier for key manager
 * policy updates costs.
 */
export declare const GAS_OP_UPDATEKEY_MANAGER = "update_keymanager";
/**
 * KindInvalid is an invalid runtime and should never be explicitly set.
 */
export declare const KIND_INVALID = 0;
/**
 * KindCompute is a generic compute runtime.
 */
export declare const KIND_COMPUTE = 1;
/**
 * KindKeyManager is a key manager runtime.
 */
export declare const KIND_KEY_MANAGER = 2;
export declare const GOVERNANCE_INVALID = 0;
export declare const GOVERNANCE_ENTITY = 1;
export declare const GOVERNANCE_RUNTIME = 2;
export declare const GOVERNANCE_CONSENSUS = 3;
export declare const GOVERNANCE_MAX = 3;
/**
 ...
 */
export declare const LATEST_RUNTIME_DESCRIPTOR_VERSION = 2;
/**
 * ModuleName is a unique module name for the registry module.
 */
export declare const MODULE_NAME = "registry";
/**
 ...
 */
export declare const ERR_BAD_CAPABILITIES_TEE_HARDWARE_CODE = 7;
/**
 ...
 */
export declare const ERR_NODE_CANNOT_BE_UNFROZEN_CODE = 14;
/**
 * ErrEntityHasNodes is the error returned when an entity cannot be deregistered
 * as it still has nodes.
 */
export declare const ERR_ENTITY_HAS_NODES_CODE = 15;
/**
 * ErrForbidden is the error returned when an operation is forbidden by
 * policy.
 */
export declare const ERR_FORBIDDEN_CODE = 16;
/**
 * ErrNodeUpdateNotAllowed is the error returned when trying to update an existing node with
 * disallowed changes.
 */
export declare const ERR_NODE_UPDATE_NOT_ALLOWED_CODE = 17;
/**
 * ErrRuntimeUpdateNotAllowed is the error returned when trying to update an existing runtime.
 */
export declare const ERR_RUNTIME_UPDATE_NOT_ALLOWED_CODE = 18;
/**
 * ErrEntityHasRuntimes is the error returned when an entity cannot be deregistered as it still
 * has runtimes.
 */
export declare const ERR_ENTITY_HAS_RUNTIMES_CODE = 19;
export declare function registerEntityWrapper(): consensus.TransactionWrapper<types.SignatureSigned>;
export declare function deregisterEntityWrapper(): consensus.TransactionWrapper<void>;
export declare function registerNodeWrapper(): consensus.TransactionWrapper<types.SignatureMultiSigned>;
export declare function unfreezeNodeWrapper(): consensus.TransactionWrapper<types.RegistryUnfreezeNode>;
export declare function registerRuntimeWrapper(): consensus.TransactionWrapper<types.RegistryRuntime>;
